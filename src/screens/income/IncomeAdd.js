...
export const IncomeAdd = (props) => {
    ...
    const handleSubmit = async () => {
        ...
        setIsLoading(true);
          try {
            ...
            const response = await fetch(serverAddress + '/addIncome', { ///addincome
              method: 'POST',
    ...
    return (
        <SafeAreaView style={tailwind('w-full h-full bg-white')}>
            ...
            <Text style={[{fontFamily: 'Roboto-Medium', fontSize: 34, color: '#333333'}, tailwind('text-center px-4')]}>Income</Text>
